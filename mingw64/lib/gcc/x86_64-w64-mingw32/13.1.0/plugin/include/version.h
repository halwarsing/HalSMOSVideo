...
#define version_string "13.1.0"
#define pkgversion_string "(MinGW-W64 x86_64-ucrt-mcf-seh, built by Brecht Sanders) "
...
#define GCOV_VERSION ((gcov_unsigned_t)0x4233312a)  /* B31* */
